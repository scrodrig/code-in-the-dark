    ...
    return(
      <footer>
            ...
            <div className="col-md-8">
              <a href="http://www.impaqto.net/" target="_blank" rel="noopener noreferrer">
                  <img className="small-logo" src="http://www.impaqto.net/wp-content/uploads/2015/05/logo.png" alt="Impaqto"/>
              </a>
              <a href="https://www.facebook.com/groups/705720476146268/" target="_blank" rel="noopener noreferrer">
              ...
              <a href="http://www.waykana.com/waykana/" target="_blank" rel="noopener noreferrer">
